...
const styles = StyleSheet.create({
  ...
  avatarValue: { marginLeft: 5, height: 19, fontWeight: 400, fontSize: 14, color: "#999999", lineHeight: 19 },
  rlBox: { height: 60, marginRight: 16, position: "relative" },
  rlImg: { width: 45, height: 45, position: "absolute", right: 16, top: -4 },
  qdBox: { marginTop: 34, height: 29, borderRadius: 22, backgroundColor: "#F57132", paddingHorizontal: 10 },
  qdText: { fontWeight: 400, fontSize: 14, color: "#FFFFFF" },
  navList: { marginTop: 32 },
  navListItem: { width: 44, height: 44, backgroundColor: "rgba(5,58,147,0.04)", borderRadius: 8 },
  navListItemImg: { width: 30, height: 30 },
  navListItemText: {
    marginTop: 8,
    height: 20,
    fontWeight: 400,
