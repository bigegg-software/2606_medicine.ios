...
const styles = StyleSheet.create({
    ...
    infoItemLabel: { fontWeight: 500, fontSize: 14, color: AppTheme.textSecondary, flexShrink: 0 },
    infoItemValue: {
        flex: 1,
        marginLeft: 12,
        minWidth: 0,
