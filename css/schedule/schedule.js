...
const styles = StyleSheet.create({
  ...
  listItemTitle: { fontWeight: "bold", fontSize: 14, color: "#333333", flexShrink: 1 },
  listItemTitleWrap: { flex: 1, flexShrink: 1, paddingRight: 8 },
  ...
  weekTrainWrap: { marginTop: 20, gap: 12, minHeight: 90 },
  ...
  historyFilterSection: { paddingTop: 18 },
